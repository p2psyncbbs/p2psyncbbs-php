...
# ログファイル保持数（システム設定）
defined( 'KEEPLOGCOUNT')? true: define( 'KEEPLOGCOUNT', $_POST[KEEPLOGCOUNT]);
# 1スレッドに投稿できるレス数の上限
defined( 'THREAD_RES')? true: define( 'THREAD_RES', $_POST[THREAD_RES]);
# レスオーバー時のメッセージ
defined( 'THREAD_MAX_MSG')? true: define( 'THREAD_MAX_MSG', '$_POST[THREAD_MAX_MSG]');
# 1スレッドの上限（バイト）
defined( 'THREAD_BYTES')? true: define( 'THREAD_BYTES', $_POST[THREAD_BYTES]);
# ファイルアップ許可
defined( 'UPLOAD')? true: define( 'UPLOAD', $_POST[UPLOAD]);
# GDバージョン
#defined( 'GD_VERSION')? true: define( 'GD_VERSION', $_POST[GD_VERSION]);
# アップロード上限（バイト）
defined( 'MAX_BYTES')? true: define( 'MAX_BYTES', $_POST[MAX_BYTES]);
# サムネイル画像の幅
defined( 'MAX_W')? true: define( 'MAX_W', $_POST[MAX_W]);
# サムネイル画像の高さ
defined( 'MAX_H')? true: define( 'MAX_H', $_POST[MAX_H]);
# おみくじ機能
defined( 'OMIKUJI')? true: define( 'OMIKUJI', $_POST[OMIKUJI]);
# 野球機能
defined( 'BASEBALL')? true: define( 'BASEBALL', $_POST[BASEBALL]);
# どこ誰何機能
defined( 'WHO_WHERE')? true: define( 'WHO_WHERE', $_POST[WHO_WHERE]);
# 壷機能（未実装）
defined( 'TUBO')? true: define( 'TUBO', $_POST[TUBO]);
# 等幅フォント機能
defined( 'TELETYPE')? true: define( 'TELETYPE', $_POST[TELETYPE]);
# スレッド内名無し名変更機能
defined( 'NAME_774')? true: define( 'NAME_774', $_POST[NAME_774]);
# 名無しへ強制変更機能
defined( 'FORCE_774')? true: define( 'FORCE_774', $_POST[FORCE_774]);
# IDなし機能
defined( 'FORCE_NO_ID')? true: define( 'FORCE_NO_ID', $_POST[FORCE_NO_ID]);
# sage強制機能
defined( 'FORCE_SAGE')? true: define( 'FORCE_SAGE', $_POST[FORCE_SAGE]);
# レス要キャップ機能
defined( 'FORCE_STARS')? true: define( 'FORCE_STARS', $_POST[FORCE_STARS]);
# スレッド内VIP機能解除
defined( 'FORCE_NORMAL')? true: define( 'FORCE_NORMAL', $_POST[FORCE_NORMAL]);
# 名前入力強制機能
defined( 'FORCE_NAME')? true: define( 'FORCE_NAME', $_POST[FORCE_NAME]);
# 0thelo機能
defined( 'ZEROTHELO')? true: define( 'ZEROTHELO', $_POST[ZEROTHELO]);
# アップロード機能
defined( 'FORCE_UP')? true: define( 'FORCE_UP', $_POST[FORCE_UP]);
?>
